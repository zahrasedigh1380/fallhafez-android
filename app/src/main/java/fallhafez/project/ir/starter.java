...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "fallhafez.project.ir", "fallhafez.project.ir.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "fallhafez.project.ir.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
